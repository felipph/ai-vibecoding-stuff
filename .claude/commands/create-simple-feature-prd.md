...
2.  **Ask Clarifying Questions:** Before writing the PRD, the AI *must* ask only the most essential clarifying questions needed to write a clear PRD. Use the AskUserQuestionTool about literally anything important for this project (e.g. technical implementation, UI & UX, concerns, tradeoffs, etc.), but make sure the questions are not obvious. Limit questions to 3-6 critical gaps in understanding. The goal is to understand the "what" and "why" of the feature, not necessarily the "how" (which the developer will figure out). Make sure to provide options in letter/number lists so I can respond easily with my selections.
...
4. For diagrams, use mermaid syntax following C4 diagram standards.